...
- "쉬했어/소변봤어/오줌 쌌어" → pee (poop 아님, 대변 언급 없으면 무조건 pee)`,
  ...
  if (sessionStatus === 'unauthenticated') {
    return (
      <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100dvh',background:'linear-gradient(135deg,#FF8040 0%,#78C96E 100%)',padding:'0 16px'}}>
        <div style={{background:'#fff',borderRadius:'28px',padding:'48px 28px',textAlign:'center',boxShadow:'0 8px 40px rgba(0,0,0,0.15)',width:'100%',maxWidth:'430px',boxSizing:'border-box'}}>
          ...
          <p style={{fontSize:'14px',color:'#aaa',marginBottom:'36px',lineHeight:1.7}}>소셜 계정으로 로그인하고<br/>아기의 성장을 함께 기록해요</p>
          <button
            onClick={() => signIn('google')}
            style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'10px',width:'100%',padding:'16px',borderRadius:'14px',border:'1.5px solid #e5e7eb',background:'#fff',fontSize:'15px',fontWeight:'600',color:'#333',cursor:'pointer',boxShadow:'0 2px 8px rgba(0,0,0,0.06)'}}
          >
